  ...
  <div
    ...
    <div class="footer-social d-flex flex-column flex-md-row justify-content-center align-items-center"
      ...
      <ul class="d-flex align-items-center my-auto">
        ...
        <li class="p-2" data-toggle="modal" data-target="#Modal_2">
          <!-- <a>
              PKR
            </a> -->
          <a id="myButton"> PKR</a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content  .modal-dialog-scrollable">
        <div class="modal-header">
          <h5 class="modal-title">Choose a currency</h5>
          ...
          <section class="selection-list">
            <div class="list-group">
              ...
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="inner-heading-modal">United States Dollar
                  <sub>USD-$</sub>
                </h4>
              </a>
              <!-- Euro -->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">Euro
                  <sub>EUR - €</sub>
                </h4>
              </a>
              <!-- British Pound -->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">British Pound
                  <sub>GBP - £</sub>
                </h4>
              </a>
              <!-- Australian Dollar -->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">Australian Dollar
                  <sub>AUD - A$</sub>
                </h4>
              </a>
              <!-- Canadian Dollar -->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">Canadian Dollar
                  <sub>CAD - CA$</sub>
                </h4>
              </a>
              <!-- Israeli Shekel -->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">Israeli Shekel
                  <sub>ILS - ₪</sub>
                </h4>
              </a>
              <!-- Brazilian Real -->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">Brazilian Real
                  <sub>BRL - R$</sub>
                </h4>
              </a>
              <!-- Hong Kong Dollar -->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">Hong Kong Dollar
                  <sub>HKD - HK$</sub>
                </h4>
              </a>
              <!-- Swedish Krona -->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">Swedish Krona
                  <sub>SEK - SEK</sub>
                </h4>
              </a>
              <!-- New Zealand Dollar -->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">New Zealand Dollar
                  <sub>NZD - NZ$</sub>
                </h4>
              </a>
              <!-- Singapore Dollar -->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">Singapore Dollar
                  <sub>SGD - SGD</sub>
                </h4>
              </a>
              <!-- Swiss Franc -->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">Swiss Franc
                  <sub>CHF - CHF</sub>
                </h4>
              </a>
              <!-- South African Rand -->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">South African Rand
                  <sub>ZAR - ZAR</sub>
                </h4>
              </a>
              <!--Chinese Renminbi Yuan -->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">Chinese Renminbi Yuan
                  <sub>CNY - CN¥</sub>
                </h4>
              </a>
              <!-- Indian Rupee -->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">Indian Rupee
                  <sub>INR - ₹</sub>
                </h4>
              </a>
              <!-- Malaysian Ringgit -->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">Malaysian Ringgit
                  <sub>MYR - MYR</sub>
                </h4>
              </a>
              <!-- Mexican Peso -->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">Mexican Peso
                  <sub>MXN - MX$</sub>
                </h4>
              </a>
              <!-- Pakistani Rupee -->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">Pakistani Rupee
                  <sub>PKR - PKR</sub>
                </h4>
              </a>
              <!-- Philippine Peso -->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">Philippine Peso
                  <sub>PHP - ₱</sub>
                </h4>
              </a>
              <!-- New Taiwan Dollar -->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">New Taiwan Dollar
                  <sub>TWD - NT$</sub>
                </h4>
              </a>
              <!--Thai Baht-->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">Thai Baht
                  <sub>THB - THB</sub>
                </h4>
              </a>
              <!-- Turkish New Lira -->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">Turkish New Lira
                  <sub>TRY - TRY</sub>
                </h4>
              </a>
              <!-- United Arab Emirates Dirham -->
              <a href="#" class="list-group-item list-group-item-action " aria-current="true">
                <h4 class="text-align-left inner-heading-modal">United Arab Emirates Dirham
                  <sub>AED - AED</sub>
                </h4>
              </a>
            </div>
