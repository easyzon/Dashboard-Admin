...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="gig.php">
            ...
            <li class="nav-item">
                <a class="nav-link text-white " href="collection.php">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">receipt_long</i>
                    </div>
                    <span class="nav-link-text ms-1">Add Collection</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white active bg-gradient-primary" href="view-collection.php">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">receipt_long</i>
                    </div>
                                                            ...
                                                            if (mysqli_num_rows($category) > 0)
                                                             {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <div class="d-flex px-2">
                                                                            <div>
                                                                                <img src="./upload/<?= $item['image']; ?>" width="50px" class="avatar avatar-sm rounded-circle me-2" alt="<?=$item['name']  ?>">
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    <td class="align-middle text-center">
                                                                    <p class="text-sm font-weight-bold mb-0"><?= $item['Status'] == '0'? "Visible":"Hidden"  ?></p>
                                                                    </td>
