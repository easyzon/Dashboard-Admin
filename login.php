...
// Login Form Connect With DataBase
            ...
            <div class="card-body">
             ...
             <?php echo $error?>
              <div class="input-group input-group-outline my-3">
                  ...
                  <input type="name" name="email" class="form-control" required="required">
                </div>
                ...
                <div class="text-center">
                  <button type="submit" value="Login" name="login" class="btn bg-gradient-primary w-100 my-4 mb-2" >Sign in</button>
                </div>
