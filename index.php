...
<div class="modal fade" id="AddUser">
        <div class="modal-dialog">
            <div class="modal-content bg-secondary">
                ...
                <form action="./assest/config/contact.php" method="POST">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="submit" name="addUser" class="btn btn-outline-light">Save</button>
                    </div>
            </div>
            </form>
            <!-- /.modal-content -->
        ...
        <div class="my-5 row align-items-center">
            <div class="qlts-content col-md-5 col-12">
                ...
                <ul class="d-flex flex-column">
                    <li>
                        <div>
                            <img src="assets\svg\tick.svg" alt="success">
